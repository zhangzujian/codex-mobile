...
6. Open a project overflow menu and a thread overflow menu; inspect Browse files, Copy path, Export Project, automation, worktree, rename, Remove, fork, pin, and copy-chat actions.
